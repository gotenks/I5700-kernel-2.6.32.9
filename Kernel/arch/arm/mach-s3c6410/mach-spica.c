...
{
	printk("spica_machine_init : start\n");
	...
	printk("spica_machine_init : stop\n");
	s3c_dump_gpio();
}

//MACHINE_START(SPICA, "SPICA")
MACHINE_START(INFOBOWLQ, "SPICA")
...
#if defined(CONFIG_MACH_INFOBOWLQ) || defined(CONFIG_MACH_MAX) || defined(CONFIG_MACH_SPICA)
